...
const int N = 30; // number of figures
...
int main() {
  ...
  while (!glfwWindowShouldClose(window)) {
    ...
    // virgencita lines
    drawWithEBO(24, 30, GL_LINE_STRIP);
    drawWithEBO(25, 10, GL_LINE_STRIP);
    drawWithEBO(26, 13, GL_LINE_STRIP);
    drawWithEBO(27, 6, GL_LINE_STRIP);
    drawWithEBO(28, 5, GL_LINE_STRIP);
    drawWithEBO(29, 5, GL_LINE_STRIP);
