...
int main() {
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        if (animating) {
            ...
            transform_top = glm::rotate(transform_top, glm::radians(rotate_gradee), glm::vec3(0.0f, 0.0f, 1.0f));
            ...
            transform_left = glm::rotate(transform_left, glm::radians(rotate_gradee), glm::vec3(0.0f, 0.0f, 1.0f));
            ...
            transform_right = glm::rotate(transform_right, glm::radians(rotate_gradee), glm::vec3(0.0f, 0.0f, 1.0f));
            ...
            std::cout << "rotate: " << rotate_gradee << std::endl;
            rotate_gradee += 3.0;
